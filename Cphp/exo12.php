...
<header>
    ...
    <main>
    <form id="mon-formulaire" method="POST" action="traitement12.php">
        <div id="enregistrements">
            <div class="enregistrement">
            <label for="Adresse Client" class="col-sm-2">Adresse Client</label>
                <br>
                <br>
                ...
                <div class="col-sm-6" >
                <input type="text" class="form-control" name="codepos" placeholder="Entrez le code postal">
                </div>
                <br>
                <br>
        <div class="col-sm-2">
        <input type="submit" id="soumettre" value="Enregistrer" class="form-control">
        </div>
        <br> <br>
</div>
</div>
