...
<header>
    ...
    <form action="" method="post">
        <label> Entrez le premier nombre </label>
        <div class="col-sm-3">
            <input type="text" id="num1" class="form-control" name="num1" placeholder="Entrez un nombre">
        </div>
        <br>
        <br>
        <label> Entrez le deuxième nombre </label>
        <div class="col-sm-3">
            <input type="text" id="num2" class="form-control" name="num2" placeholder="Entrez un nombre">
        </div>
        <br>
        <br>
        <div class="col-sm-2">
            <button type="submit" class="form-control" id="calcul"> Chercher le ppmc</button>
        <br> <br>
        </div>
    </form>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        for ($i = max($num1, $num2); $i <= $num1 * $num2; $i += max($num1, $num2)) {
            if ($i % $num1 == 0 && $i % $num2 == 0) {
                echo "Le ppmc de ces deux nombres est $i";
                break;
            }
        }
    }
