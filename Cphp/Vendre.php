...
<header>
    ...
    <?php
    echo "<h2 class='display-5 fw-bold'> Vente Maison/Appartement </h2>
        <br>
        <br>
            <h4> <label for='spec'>Spécifications de votre Appartement ou Maison à vendre </label>
        <br>
            <div class='col-sm-6' >
        <input type='text' class='form-control' name='adresse' placeholder='Entrez vos spécifications'>
        </div>
            </h4>
        <div class='col-sm-2'>
        <button type='submit' class='form-control' id='calculs'> Faire des recherches </button>
        <br>
        <br>
        </div>";
?>
