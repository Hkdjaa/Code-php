...
<header>
    ...
    <main>
    <form id="mon-formulaire" method="POST" action="#">
        <div id="enregistrements">
            <div class="enregistrement">
                ...
                <div class="col-sm-6">
                    <input type="text" id="ht" class="form-control" name="ht" placeholder="Entrez le prix hors taxes">
                </div>
                <br>
                <br>
                <br>
                ...
                <div class="col-sm-6">
                    <input type="text" id="tva" class="form-control" name="tva" placeholder="Entrez la taxe sur la valeur ajoutée">
                </div>
                <br>
                <br>
                <br>
                <div class="row row text-center">
                    <div class="col-sm-2">
                        <input type="submit" id="soumettre" value="Valider" name="valider" class="form-control">
                        <br> <br>
                    </div>
                </div>
            </div>
    ...
    <span style="color: #d66060;">
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['valider'])) {
            $HT = isset($_POST['ht']) ? floatval($_POST['ht']) : 0;
            $tauxTVA = isset($_POST['tva']) ? floatval($_POST['tva']) : 0;
            $TVA = $HT * ($tauxTVA / 100);
            $TTC = $HT + $TVA;

            echo "<h4> Montant de la TVA : </h4>" . $TVA;
            echo "<br>";
            echo " <h4> Prix TTC : </h4>" . $TTC;
        }
        ?>
    </span>
</main>
