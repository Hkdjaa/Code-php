...
<header>
    ...
    <?php
   echo "<h2 class='display-5 fw-bold'> Louer un Appartement/Maison </h2>
   <br>
   <br>
    <h4> <label for='spec'>Critères de recherche </label>
    <br>
    <div class='col-sm-6' >
    <input type='text' class='form-control' name='adresse' placeholder='Entrez vos spécifications de location'>
    </div>
    </h4>
    <div class='col-sm-2'>
    <button type='submit' class='form-control' id='soumettre'> Faire des recherches </button>
    <br>
    <br>
</div>";
?>
