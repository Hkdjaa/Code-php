...
<header>
    ...
    <form id="mon-formulaire">
        <div id="enregistrements">
            <div class="enregistrement">
                ...
                <br>
                <h2>
                <label for="infos" style="color: #d66060;"> Bienvenue sur J'achète.com</label> </h2>
                <br>
                <br>
                <h2>
                <label for="infos" style="color: #d66060;"> Veuillez choisir le service qui vous intéresse. Passez un bon moment !!</label> </h2>
                <br>
                <br>
                <br>
        </div>
    ...
    <?php
   echo " <div class='row row text-center'>
   <div class='col-sm-2'>
       <a href='Vendre.php'>
   <button type='button' id='vendre' class='form-control'> Vendre</button></a>
</div>
<div class='col-sm-2'>
   <a href='Acheter.php'>
   <button type='button' id='acheter' class='form-control'>Acheter</button></a>
</div>
<div class='col-sm-2'>
   <a href='Louer.php'>
   <button type='button' id='louer' class='form-control'>Louer</button></a>
   </div>
   <br>";
?>
    </span>
