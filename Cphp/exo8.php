...
<header>
    ...
    <?php
$personnes = array(
    'Balde' => array('Aïssatou', 'Leeds', 25),
    'Ndiaye' => array('Clarisse', 'Dubaï', 32),
    'Ba' => array('Tijani', 'Sherbrooke', 21),
    'Diop' => array('Cheikhou', 'Dakar', 44)
);
echo "Nom: Balde Prénom: " . $personnes['Balde'][0] . ' Ville: ' . $personnes['Balde'][1] . ' Âge: ' . $personnes['Balde'][2];
echo "<br>";
echo "<br>";
echo "Nom: Ndiaye Prénom: " . $personnes['Ndiaye'][0] . ' Ville: ' . $personnes['Ndiaye'][1] . ' Âge: ' . $personnes['Ndiaye'][2];
echo "<br>";
echo "<br>";
echo "Nom: Ba Prénom: " . $personnes['Ba'][0] . ' Ville: ' . $personnes['Ba'][1] . ' Âge: ' . $personnes['Ba'][2];
echo "<br>";
echo "<br>";
echo "Nom: Diop Prénom: " . $personnes['Diop'][0] . ' Ville: ' . $personnes['Diop'][1] . ' Âge: ' . $personnes['Diop'][2];
