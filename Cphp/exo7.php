...
<header>
    ...
    <form action="" method="post">
        <label> Entrez le nombre que vous souhaitez </label>
        <div class="col-sm-3">
            <input type="text" id="num" class="form-control" name="num" placeholder="Entrez un nombre">
        </div>
        <br>
        <br>
        <div class="col-sm-4">
            <button type="submit" class="form-control" id="calcul"> Vérifier s'il est parfait </button>
            <br> <br>
        </div>
    </form>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if ($somme == $num) {
            echo "Ce nombre est bien un nombre parfait";
        } else {
