...
<header>
    ...
    <form action="" method="post">
        <label> Saisissez le rayon </label>
        <div class="col-sm-3">
            <input type="text" id="rayon" class="form-control" name="rayon" placeholder="Entrez le rayon">
        </div>
        <br>
        <br>
        <div class="col-sm-2">
            <button type="submit" class="form-control" id="calculs"> Faire les calculs</button>
            <br>
            <br>
        </div>
    </form>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        echo "Le diamètre est $diametre <br> Le périmètre est $perimetre <br> La surface est $surface";
    }
    ?>
    </span>
</main>
